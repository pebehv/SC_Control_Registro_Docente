...
@Component({
  selector: 'app-estruct-add',
  standalone: false,
  //imports: [],
  templateUrl: './estruct-add.component.html',
  styleUrl: './estruct-add.component.css'
})
export class EstructAddComponent {
  ...
  setForm(): void {
    this.valForm.reset({
      ...
      docent_boolean: this.docenteSelected.docent_boolean,
     ...
     // console.log("actualizar********",this.valForm)
      ...
      next: (response) => {
        ...
        this.insertarDocente(1,this.docenteSelected.docente, 
          ...
          1,
          this.valForm.value['docent_boolean'] ? 1:0
         )   
